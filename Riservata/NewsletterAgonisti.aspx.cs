...
public partial class Riservata_NewsletterAgonisti : System.Web.UI.Page
{
    ...
    protected void InviaButton_Click(object sender, EventArgs e)
    {
        ...
        String from = "webservice@shotokenshukai.eu";
        //String to = "list1.c61439.bhym@2many.it";
        String to = "g30.list3.c61439.u1pk@2many.it";
        ...
        //L'oggetto 
        mMailMessage.Subject = "Agonisti Shotokenshukai";
        //Il corpo 
