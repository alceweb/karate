...
<asp:Content ID="Content1" ContentPlaceHolderID="Admin" Runat="Server">
    ...
    <asp:ListView ID="ListView1" OnSelectedIndexChanged="ListView1_SelectedIndexChanged" SelectedIndex="0" runat="server" DataKeyNames="Id" DataSourceID="SqlDataSource1" >
